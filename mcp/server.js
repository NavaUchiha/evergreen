#!/usr/bin/env node
/* Evergreen MCP server — exposes the Evergreen backend as agent tools over stdio.
   Config (env):
     EVERGREEN_API    API base   (default https://140.245.228.37.sslip.io/api)
     EVERGREEN_TOKEN  write password (required for publish_concept)
     EVERGREEN_SITE   Pages base (default https://navauchiha.github.io/evergreen) — for URLs */
